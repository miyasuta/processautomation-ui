		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Start UI",
									"targetURL": "#demoworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoworkflowuimodule-display": {
								"semanticObject": "demoworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.workflowuimodule",
									"url": sap.ui.require.toUrl("demo/workflowuimodule")
								}
							}
						}
					}
